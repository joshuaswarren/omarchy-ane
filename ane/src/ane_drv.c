 ...
 *  - T6001/jw16 (apple,t6000-dart x3, APPLE_DART2 PTEs): (1) the ANE sits in
 ...
 *  - T8103/jwm1 (apple,t8103-dart x3, APPLE_DART1 PTEs): the DART1 PTE
...
static const struct ane_soc ane_soc_t6021 = {
	/* M2 Max (T6021, jw14m2). SET window 0x8e08c000 = pmgr base
