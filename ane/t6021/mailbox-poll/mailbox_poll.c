...
/* dup-export stripped: builtin vmlinux owns the export; see receipts/2026-09-22-t6021-rtkit-port */
...
static struct platform_driver apple_mbox_driver = {
	.driver = {
		.name = "apple-mailbox-poll"/* coexistence with builtin: same OF match, distinct driver name */,
