 ...
 * Feeds the exact SET-block ACTUAL words from the 2026-09-20 jwm1
...
int main(void)
{
	...
	/* 2026-09-20 jwm1 first-load wedge: set0 powered, base and
	...
	expect("wedged-jwm1-20260920", agg(wedged), false);
